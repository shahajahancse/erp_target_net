      ...
      <div class="nodedocuments" id="documents10" style="display: block; margin-left: 16px;">
		...
		<div class="document">
		  ...
		  <div class="document">
            ...
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/setup_con/holiday_allowance_rules_setup" title="Production Bonus Rules" target="right" id="dp60114" onClick="MakeColoredBack('60114');">Holiday Aloowance Rules</a>
            </div>
        ...
        <div class="nodedocuments" id="documents300" style="display: none; Margin-left: 16;">
          ...
          <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/manual_attendance_con/manual_attendance_data_entry_for_fixed" title="Manual Attendance" target="right" id="dp13011" onClick="MakeColoredBack('6023');">Manual Attendance For Fixed</a>
          </div>
	  ...
	  <div class="nodedocuments" id="documents600" style="display: block; margin-left: 16px;">
        ...
        <div class="nodeheader">
         ...
         <div class="document">
          ...
          <?php $ses_username =$this->session->userdata('username'); 
          
          if($ses_username == "alamin" || $ses_username == "kamrul" || $ses_username == "target")
			{
          ?>
          <div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
          ...
          <!--<div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/production_setup_con/section_wise_process" title="Sectionwise Process" target="right" id="dp60113" onClick="MakeColoredBack('60113');">Section wise Process</a>
          </div>-->
		...
		<div class="document">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/blank.gif">
            <img src="<?php echo base_url();?>/images/tree_image/utree_data/bullet.gif">
            <a class="header" href="<?php echo base_url();?>index.php/manual_attendance_con/manual_attendance_data_entry" title="Manual Attendance" target="right" id="dp6023" onClick="MakeColoredBack('6023');">Manual Attendance</a>
          </div>
